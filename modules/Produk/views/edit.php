					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8 float-md-left">
								<input class="form-control elipsis" type="hidden" name="id_produk"  value="<?=@$item->id_produk?>" />
								<input class="form-control elipsis" type="text" name="nama_produk" placeholder="<?=ucwords(str_replace('_', ' ', 'nama'))?>" value="<?=@$item->nama_produk?>" required/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8 float-md-left">
								<textarea class="form-control"  name="deskripsi" placeholder="<?=ucwords(str_replace('_', ' ', 'deskripsi'))?>" ><?=@$item->deskripsi?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8 float-md-left">
								<input class="form-control elipsis" type="text" name="harga" placeholder="<?=ucwords(str_replace('_', ' ', 'harga'))?>" value="<?=@$item->harga?>" required/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8  float-md-left">
								<input type="checkbox" class="make-switch" <?= @$item->status== 'Y' ? 'checked': '' ?>  name="status" data-on-text="&nbsp;Laki - Laki&nbsp;" data-off-text="&nbsp;Perempuan&nbsp;" data-on-color="primary" data-off-color="danger" >
							</div>
						</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<div class="col-md-9 " >
								<div class="col-md-4 " >
									<div class="col-md-12">
										<div class="fileinput <?= empty(@$item->gambar) ? "fileinput-new" :"fileinput-exists"?>"  data-provides="fileinput">
											<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"> 
												<?= empty(@$item->gambar) ? "" :"<img src='". base_url('assets/upload/produk')."/". $item->gambar ."'/>"?>
											</div>
											<div>
								...
								<input type="hidden" name="old_gambar" value="<?= @$item->gambar ?>"> </span>
							</div>
						</div>
					</div>
				</div>
